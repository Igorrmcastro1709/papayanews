          ...
          <Card className="border-2 shadow-2xl">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl md:text-3xl">
                Junte-se à Comunidade PapayaNews
              </CardTitle>
              <CardDescription className="text-base">
                Acesse conteúdos exclusivos sobre IA, startups e inovação
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Button
                className="w-full h-14 text-base gap-3 bg-white hover:bg-gray-50 text-gray-700 border-2 shadow-sm"
                onClick={() => window.location.href = getLoginUrl()}
              >
              ...
              <Button
                className="w-full h-14 text-base gap-3 bg-[#0A66C2] hover:bg-[#004182] text-white"
                onClick={() => window.location.href = getLoginUrl()}
              >
